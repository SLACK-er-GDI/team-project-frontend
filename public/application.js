...
var config = {
  apiOrigins: {
    production: 'https://team-project-heroku.herokuapp.com'
  }
};
...
var _decorators = __webpack_require__(148);

var _logger = __webpack_require__(150);
...
var setAPIOrigin = __webpack_require__(133);
var config = __webpack_require__(5);
var fileevents = __webpack_require__(135);
var authevents = __webpack_require__(157);
// const getPolicy = require('./files/fileapi')
var filestack = __webpack_require__(160);
...
var parseNestedQuery = __webpack_require__(134);
...
var _filestackJs = __webpack_require__(6);
...
var fileapi = __webpack_require__(136);
var fileui = __webpack_require__(137);
var store = __webpack_require__(3);

var getUploadsRefresh = function getUploadsRefresh(event) {
  fileapi.getUploads().then(filterUserUploads).then(fileui.getUserUploadsSuccess).then(onDeleteUpload).then(editUpload).then(updateUpload).catch(fileui.getUserUploadsFailure);
};

var getAllUploadsRefresh = function getAllUploadsRefresh(event) {
  fileapi.getUploads().then(fileui.getUploadsSuccess).catch(fileui.getUploadsFailure);
};
...
var onFileUpload = function onFileUpload(event) {
  ...
  fileapi.fileUpload(data).then(fileui.fileCreateSuccess).then(getUploadsRefresh).catch(fileui.fileCreateFailure);
};

var onFileUploadAll = function onFileUploadAll(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  if (!jQuery.isEmptyObject(data.tags)) {
    data.upload['tags'] = Object.keys(data.tags);
  ...
  data.upload['ownerEmail'] = store.user.email;
  fileapi.fileUpload(data).then(fileui.fileCreateAllSuccess).then(getAllUploadsRefresh).catch(fileui.fileCreateAllFailure);
};
...
var onDeleteUpload = function onDeleteUpload() {
  $('.remove').on('click', function (event) {
    ...
    .then(fileui.deleteUploadSuccess).then(getUploadsRefresh).catch(fileui.deleteUploadFailure);
  });
};

var checkboxChecker = function checkboxChecker(array) {
...
var editUpload = function editUpload() {
  ...
  $('.edit').on('click', function (event) {
    ...
    fileapi.getUserUpload(index).then(function (data) {
      var title = data.upload.title;
      var description = data.upload.description;
...
var updateUpload = function updateUpload() {
  ...
  $('#edit-upload-form').on('submit', function (event) {
    ...
    fileapi.updateUpload(data, store.uploadId).then(fileui.updateUploadSuccess).then(getUploadsRefresh).catch(fileui.updateUploadFailure);
  });
};

var filterUserUploads = function filterUserUploads(array) {
  var userArray = [];
  for (var i = 0; i < array.upload.length; i++) {
...
var onGetUserUploads = function onGetUserUploads(event) {
  event.preventDefault();
  fileapi.getUploads().then(filterUserUploads).then(fileui.getUserUploadsSuccess).then(onDeleteUpload).then(editUpload).then(updateUpload).catch(fileui.getUserUploadsFailure);
};
...
var onGetUploads = function onGetUploads(event) {
  event.preventDefault();
  fileapi.getUploads().then(fileui.getUploadsSuccess).then(onDeleteUpload).catch(fileui.getUploadsFailure);
};
...
var addFileHandlers = function addFileHandlers() {
...
module.exports = {
  ...
  addFileHandlers: addFileHandlers,
  onDeleteUpload: onDeleteUpload,
  onFileUploadAll: onFileUploadAll,
  onGetUploads: onGetUploads,
  onGetUserUploads: onGetUserUploads
};
...
var fileUpload = function fileUpload(data) {
  return $.ajax({
...
var getUserUpload = function getUserUpload(data) {
  return $.ajax({
...
var updateUpload = function updateUpload(data, uploadId) {
  return $.ajax({
...
var showUploadsTemplate = __webpack_require__(138);
var showAllUploadsTemplate = __webpack_require__(154);
var moment = __webpack_require__(0);

var store = __webpack_require__(3);

var dateFormatter = function dateFormatter(data) {
  for (var i = 0; i < data.length; i++) {
    var formatUpdated = data[i].updatedAt.split('T');
    var formatCreation = data[i].createdAt.split('T');
...
var fileCreateSuccess = function fileCreateSuccess() {
...
var fileCreateFailure = function fileCreateFailure() {
  alertCallerFailure('frontError', 'Upload Failure');
  failureShake('file-upload-modal');
};

var fileCreateAllSuccess = function fileCreateAllSuccess() {
...
var fileCreateAllFailure = function fileCreateAllFailure() {
  alertCallerFailure('frontError', 'Upload Failure');
...
var getUploadsSuccess = function getUploadsSuccess(data) {
  ...
  var showUploadsHtml = showAllUploadsTemplate({ uploads: newData });
...
var getUploadsFailure = function getUploadsFailure() {
  alertCallerFailure('frontError', 'Unable to Retrieve Uploads');
};

var deleteUploadSuccess = function deleteUploadSuccess(data) {
...
var getUserUploadsSuccess = function getUserUploadsSuccess(data) {
  if (data.length !== 0) {
    var policy = store.policy;
    var signature = store.signature;
    var newData = [];
    ...
    dateFormatter(newData);
    var showUploadsHtml = showUploadsTemplate({ uploads: newData });
    $('#uploads-thumbnails').html(showUploadsHtml);
    $('[data-toggle="popover"]').popover();
  } else {
    var _showUploadsHtml = showUploadsTemplate({ uploads: data });
    $('#uploads-thumbnails').html(_showUploadsHtml);
...
var getUserUploadsFailure = function getUserUploadsFailure() {
  alertCallerFailure('frontError', 'Unable to Retrieve User Uploads');
};

var updateUploadSuccess = function updateUploadSuccess() {
...
var clearFormFields = function clearFormFields(event) {
  // $('#modal-url').val('')
  // $('.modal-url').val('')
  $('#file-upload-form')[0].reset();
  $('#file-upload-all-form')[0].reset();
...
module.exports = {
  fileCreateSuccess: fileCreateSuccess,
  fileCreateFailure: fileCreateFailure,
  getUploadsSuccess: getUploadsSuccess,
  getUploadsFailure: getUploadsFailure,
  deleteUploadFailure: deleteUploadFailure,
  deleteUploadSuccess: deleteUploadSuccess,
  getUserUploadsFailure: getUserUploadsFailure,
  getUserUploadsSuccess: getUserUploadsSuccess,
  updateUploadSuccess: updateUploadSuccess,
  updateUploadFailure: updateUploadFailure,
  fileCreateAllSuccess: fileCreateAllSuccess,
  fileCreateAllFailure: fileCreateAllFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<!-- go through uploads array and do something on each one -->\n        <div class=\"grid col-sm-6 col-md-3\">\n           <div class=\"thumbnail\">\n\n               <h4><a href=\"#\" class=\"hb-buttons thumbnail-images contextDisplay\" data-trigger=\"focus\" data-toggle=\"popover\" title=\"Image Properties\" data-html=\"true\" data-content=\"Uploader: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ownerEmail : stack1), depth0))
    + "<br />Date Created: "
    ...
    + "\" onerror=this.src=\"https://i.imgur.com/TZljVDd.jpg\">\n               <!-- <p>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.tags : stack1), depth0))
    + "</p> -->\n              <!-- <p>Uploader: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ownerEmail : stack1), depth0))
    + "</p> -->\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.tags : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "               <a href=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
    + "\" class=\"hb-buttons download-button\" download=\"testit\">Download</a>\n               <div class=\"edit-div\"><button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" class=\"remove btn edit-modal-buttons col-xs-6\">Remove</button></div>\n               <div class=\"edit-div editButton\"><button data-toggle=\"modal\" class=\"edit btn edit-modal-buttons col-xs-6\" data-target=\"#edit-upload-modal\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
  ...
  return "               <p>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[1][0]) != null ? stack1.tags : stack1),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "               </p>\n";
...
var _handlebarsSafeString = __webpack_require__(151);
...
var _handlebarsRuntime = __webpack_require__(152);

var runtime = _interopRequireWildcard(_handlebarsRuntime);

var _handlebarsNoConflict = __webpack_require__(153);
...
var _helpersBlockHelperMissing = __webpack_require__(141);

var _helpersBlockHelperMissing2 = _interopRequireDefault(_helpersBlockHelperMissing);

var _helpersEach = __webpack_require__(142);

var _helpersEach2 = _interopRequireDefault(_helpersEach);

var _helpersHelperMissing = __webpack_require__(143);

var _helpersHelperMissing2 = _interopRequireDefault(_helpersHelperMissing);

var _helpersIf = __webpack_require__(144);

var _helpersIf2 = _interopRequireDefault(_helpersIf);

var _helpersLog = __webpack_require__(145);

var _helpersLog2 = _interopRequireDefault(_helpersLog);

var _helpersLookup = __webpack_require__(146);

var _helpersLookup2 = _interopRequireDefault(_helpersLookup);

var _helpersWith = __webpack_require__(147);
...
var _decoratorsInline = __webpack_require__(149);
...
var getFormFields = __webpack_require__(9);
var authapi = __webpack_require__(158);
var authui = __webpack_require__(159);
...
var newSecurity = void 0;

var getFilestackPolicy = function getFilestackPolicy() {
  return $.ajax({
    url: 'https://team-project-heroku.herokuapp.com/filestack',
    method: 'GET'
  }).then(function (security) {
    var api = security.api;
    var policyAndSignature = {
      policy: security.policy,
      signature: security.signature
    };
    store.policy = policyAndSignature.policy;
    store.signature = policyAndSignature.signature;
    fsClient = _filestackJs2.default.init(api, policyAndSignature);
  });
};
...
function openPicker() {
  fsClient.pick({
    ...
    var getImageurl = response.filesUploaded[0].url;
...
var addFileStackHandlers = function addFileStackHandlers() {
  $('.file-picker-button').on('click', openPicker);
};

module.exports = {
  addFileStackHandlers: addFileStackHandlers,
  fsClient: fsClient,
  getFilestackPolicy: getFilestackPolicy,
